-- PetTagi — odbiorca płatności zapisany na zamówieniu (Wiktoria / Łukasz)
...
alter table public.orders
  drop constraint if exists orders_payment_recipient;

alter table public.orders
  add constraint orders_payment_recipient check (
